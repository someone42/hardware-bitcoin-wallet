...
{
	// "spec" refers to one of the values in MiscStrings. See MiscStrings
	...
	// transaction error (eg. TRANSACTION_TOO_MANY_INPUTS should correspond to
	// something like "Transaction has too many inputs").
