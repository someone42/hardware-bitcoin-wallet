...
/* Generated by nanopb-0.2.0 at Thu Mar 07 02:15:23 2013. */
...
const pb_field_t NewWallet_fields[5] = {
    ...
    PB_FIELD(  2, BYTES   , OPTIONAL, STATIC, NewWallet, encryption_key, wallet_number, 0),
    PB_FIELD(  3, STRING  , OPTIONAL, STATIC, NewWallet, wallet_name, encryption_key, 0),
...
const pb_field_t LoadWallet_fields[3] = {
    ...
    PB_FIELD(  2, BYTES   , OPTIONAL, STATIC, LoadWallet, encryption_key, wallet_number, 0),
    PB_LAST_FIELD
};
...
const pb_field_t ChangeWalletName_fields[2] = {
    PB_FIELD(  1, STRING  , REQUIRED, STATIC, ChangeWalletName, wallet_name, wallet_name, 0),
    PB_LAST_FIELD
};
...
const pb_field_t WalletInfo_fields[4] = {
    PB_FIELD(  1, UINT32  , REQUIRED, STATIC, WalletInfo, version, version, 0),
    PB_FIELD(  2, STRING  , REQUIRED, STATIC, WalletInfo, wallet_name, version, 0),
